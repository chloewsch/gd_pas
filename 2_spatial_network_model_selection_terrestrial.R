...
#write.csv(sf_res, 'model_coef_compare_k.csv', quote = F)
...
sf_res <- rbind(sf_gdr, sf_arr, sf_fstr, sf_ner)
#write.csv(sf_res, 'model_coef_compare_k_DIST.csv', quote = F)
